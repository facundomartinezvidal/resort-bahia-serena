...
WHERE id_servicio_adicional = 1;

DECLARE @margen_gimnasio DECIMAL(10, 2) = dbo.fn_calcular_margen_servicio(1);
...
DECLARE @margen_traslado DECIMAL(10, 2) = dbo.fn_calcular_margen_servicio(2);
...
EXEC dbo.sp_reservar_habitacion
    ...
    @fecha_inicio = '2025-12-15',
    @fecha_fin = '2025-12-20',
    @id_servicio_adicional = 1,  -- Gimnasio
    @cantidad_servicio = 2;
...
BEGIN TRY
    EXEC dbo.sp_reservar_habitacion
        ...
        @id_servicio_adicional = 2;  -- Servicio con margen negativo
END TRY
BEGIN CATCH
    PRINT 'Error: ' + ERROR_MESSAGE();
END CATCH
